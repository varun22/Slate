                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="https://flowbite.com" className="flex ms-2 md:me-24">
                            <img src="/Group1000000854.svg" className="h-12 me-3" alt="FlowBite Logo" /><img/>
                        </a>
                    </div>
                        ...
                        <div className="flex items-center ms-3">
                            ...
                            <div className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                                ...
                                <ul className="py-1" role="none">
                                    <li>
                                        <a href="#" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Dashboard</a>
                                    </li>
                                    <li>
